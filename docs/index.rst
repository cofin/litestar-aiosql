...
Installing ``litestar-aiosql`` is as easy as calling your favorite Python package manager:
...
.. tab-set::
    ...
    .. tab-item:: pip
        ...
        .. code-block:: bash
            ...
            python3 -m pip install litestar-aiosql
