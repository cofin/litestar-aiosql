...
from litestar_aiosql.__metadata__ import __project__ as project
from litestar_aiosql.__metadata__ import __version__ as version
...
nitpick_ignore_regex = [
    (PY_RE, r"litestar_litestar_aiosql.*\.T"),
]
...
html_theme_options = {
    ...
    "github_url": "https://github.com/cofin/litestar-aiosql",
    "nav_links": [
        {"title": "Home", "url": "https://cofin.github.io/litesatr-aiosql/"},
        {"title": "Docs", "url": "https://cofin.github.io/litesatr-aiosql/latest/"},
        {"title": "Code", "url": "https://github.com/cofin/litestar-aiosql"},
    ],
    "light_css_variables": {
        # RGB
